...
BeltsCalibrationPanel::BeltsCalibrationPanel(GcodeTransmitClient &c, std::mutex &l)
    : gcode_transmit_(c), lv_lock(l), cont(lv_obj_create(lv_scr_act())), graph_cont(lv_obj_create(cont)), graph(lv_img_create(graph_cont)), spinner(lv_spinner_create(cont, 1000, 60)), excite_control(lv_obj_create(cont)), excite_slider(lv_slider_create(excite_control)), excite_label(lv_label_create(excite_control)), excite_dd(lv_dropdown_create(excite_control)), button_cont(lv_obj_create(cont)), calibrate_btn(button_cont, &resume, "Shake Belts", &BeltsCalibrationPanel::_handle_callback, this), excite_btn(button_cont, &inputshaper_img, "Excitate", &BeltsCalibrationPanel::_handle_callback, this), emergency_btn(button_cont, &emergency, "Stop", &BeltsCalibrationPanel::_handle_callback, this,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "Do you want to emergency stop?",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       [&c]() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           spdlog::debug("emergency stop pressed");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           c.send_jsonrpc("printer.emergency_stop");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       }),
      back_btn(button_cont, &back, "Back", &BeltsCalibrationPanel::_handle_callback, this), image_fullsized(false)
{
...
void BeltsCalibrationPanel::handle_callback(lv_event_t *event)
{
    ...
    if (btn == calibrate_btn.get_container()) {
        ...
        gcode_transmit_.gcode_script(fmt::format("GUPPY_BELTS_SHAPER_CALIBRATION PNG_OUT_PATH={} PNG_WIDTH={} PNG_HEIGHT={}",
                                                 png_path, screen_width, screen_height));

        // gcode_transmit_.gcode_script(fmt::format("GUPPY_BELTS_SHAPER_CALIBRATION PNG_OUT_PATH={} PNG_WIDTH={} PNG_HEIGHT={} FREQ_START=5 FREQ_END=10",
        // 				png_path, screen_width, screen_height));
        ...
        gcode_transmit_.gcode_script(fmt::format("GUPPY_EXCITATE_AXIS_AT_FREQ FREQUENCY={} AXIS={}", excite_hz, excite_buf));
