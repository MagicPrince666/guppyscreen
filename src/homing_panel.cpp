...
HomingPanel::HomingPanel(GcodeTransmitClient &websocket_client, std::mutex &lock)
    : NotifyConsumer(lock), gcode_transmit_(websocket_client), homing_cont(lv_obj_create(lv_scr_act())), home_all_btn(homing_cont, &home, "Home All", &HomingPanel::_handle_callback, this), home_xy_btn(homing_cont, &home, "Home XY", &HomingPanel::_handle_callback, this), y_up_btn(homing_cont, &arrow_up, "Y+", &HomingPanel::_handle_callback, this), y_down_btn(homing_cont, &arrow_down, "Y-", &HomingPanel::_handle_callback, this), x_up_btn(homing_cont, &arrow_right, "X+", &HomingPanel::_handle_callback, this), x_down_btn(homing_cont, &arrow_left, "X-", &HomingPanel::_handle_callback, this), z_up_btn(homing_cont, &z_closer, "Z+", &HomingPanel::_handle_callback, this), z_down_btn(homing_cont, &z_farther, "Z-", &HomingPanel::_handle_callback, this), emergency_btn(homing_cont, &emergency, "Stop", &HomingPanel::_handle_callback, this,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "Do you want to emergency stop?",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               [&websocket_client]() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   spdlog::debug("emergency stop pressed");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   websocket_client.send_jsonrpc("printer.emergency_stop");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               }),
      motoroff_btn(homing_cont, &motor_off_img, "Motor Off", &HomingPanel::_handle_callback, this), back_btn(homing_cont, &back, "Back", &HomingPanel::_handle_callback, this), distance_selector(homing_cont, "Move Distance (mm)",
...
void HomingPanel::handle_callback(lv_event_t *event)
{
    ...
    if (btn == home_all_btn.get_container()) {
        ...
        gcode_transmit_.gcode_script("G28 X Y Z");

    } else if (btn == home_xy_btn.get_container()) {
        spdlog::debug("home xy pressed");
        gcode_transmit_.gcode_script("G28 X Y");
        ...
        gcode_transmit_.gcode_script("M84");
    ...
    if (move_op.size() > 0) {
        // gcode_transmit_.gcode_script("G91");
        gcode_transmit_.gcode_script(fmt::format("G91\n{}", move_op));
    }
}
